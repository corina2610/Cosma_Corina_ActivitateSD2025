...
//}
//
//void stergereElementDupaCriteriu(LD lista, const char* nume){
//	if (lista.prim) {
//		Nod* aux = lista.prim;
//		while (aux) {
//			if (strcmp(aux->info.numeCumparator, nume) == 0) {
//				Nod* deSters = aux;
//
//				if (aux->prev == NULL) {
//	
...
//
//				aux = aux->next; 
//				free(deSters->info.numeCumparator);
//				free(deSters);
//			}
//			else {
//				aux = aux->next;
...
//	afisareLista(lista);
//	stergereElementDupaCriteriu(lista, "Maria");
//	afisareLista(lista);
//}
